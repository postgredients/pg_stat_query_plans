...
LANGUAGE SQL
AS $$
  SHOW pg_stat_query_plans.track;
  show pg_stat_query_plans.track;
  SHOW pg_stat_query_plans.track_utility;
$$;
SET pg_stat_query_plans.track_utility = TRUE;
-- all-level tracking.
SET pg_stat_query_plans.track = 'all';
...
SELECT toplevel, calls, rows, query FROM pg_stat_query_plans ORDER BY query COLLATE "C";
