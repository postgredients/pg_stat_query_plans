 ...
 */
void
pgqpAppendJumble(pgqpJumbleState * jstate, const unsigned char *item,
				 Size size)
{
 ...
 */
void
pgqpJumbleQuery(pgqpJumbleState * jstate, Query *query)
{
 ...
 */
void
pgqpJumbleRangeTable(pgqpJumbleState * jstate, List *rtable)
{
	ListCell   *lc;
 ...
 */
void
pgqpJumbleRowMarks(pgqpJumbleState * jstate, List *rowMarks)
{
	ListCell   *lc;
 ...
 */
void
pgqpJumbleExpr(pgqpJumbleState * jstate, Node *node)
{
	ListCell   *temp;
 ...
 */
void
pgqpRecordConstLocation(pgqpJumbleState * jstate, int location)
{
 ...
 */
char *
pgqp_gen_normquery(pgqpJumbleState * jstate, const char *query, int query_loc,
				   int *query_len_p)
{
	char	   *norm_query;
 ...
 */
void
pgqp_fill_in_constant_lengths(pgqpJumbleState * jstate, const char *query,
							  int query_loc)
{
 ...
 */
int
pgqp_comp_location(const void *a, const void *b)
{
...
#if PG_VERSION_NUM >= 190000
char *
pgqp_gen_normquery(const JumbleState *jstate, const char *query, int query_loc,
				   int *query_len_p)
{
	LocationLen *locs;
#else
char *
pgqp_gen_normquery(JumbleState *jstate, const char *query, int query_loc,
				   int *query_len_p)
{
#endif
	char	   *norm_query;
 ...
 */
void
pgqp_fill_in_constant_lengths(JumbleState *jstate, const char *query,
							  int query_loc)
{
	LocationLen *locs;
	core_yyscan_t yyscanner;
